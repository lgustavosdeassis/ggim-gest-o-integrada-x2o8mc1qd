...
//   AS $function$
//   BEGIN
//     INSERT INTO public.profiles (id, email, name, role, job_title, allowed_tabs)
//     VALUES (
//       NEW.id,
//       NEW.email,
//       COALESCE(NEW.raw_user_meta_data->>'name', 'Usuário'),
//       COALESCE(NEW.raw_user_meta_data->>'role', 'viewer'),
//       COALESCE(NEW.raw_user_meta_data->>'job_title', 'Visualizador'),
//       COALESCE(NEW.raw_user_meta_data->'allowed_tabs', '[]'::jsonb)
//     )
