  ...
  return (
    <div className="space-y-6 print-break-inside-avoid animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h3 className="text-xl font-bold text-white">Infraestrutura e Locais</h3>
      </div>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <Card className="border-border/20 shadow-lg bg-card hover:bg-muted/20 transition-all rounded-2xl">
          ...
          <CardContent>
            <div className="text-4xl font-black text-white">{data.totalUsages}</div>
        ...
        <Card className="border-border/20 shadow-lg bg-card hover:bg-muted/20 transition-all rounded-2xl">
          ...
          <CardContent>
            <div className="text-4xl font-black text-white">{data.uniqueLocations}</div>
        ...
        <Card className="border-border/20 shadow-lg bg-background/50 rounded-2xl sm:col-span-2">
          ...
          <CardContent>
            {data.topLocation.count > 0 ? (
              <div className="flex items-center justify-between">
                <div className="text-xl font-bold text-white leading-snug pr-6 break-words max-w-[70%]">
                  {data.topLocation.names.join(' / ')}
                </div>
                <div className="shrink-0 text-center px-5 py-3 bg-primary/10 rounded-xl border border-primary/20">
                  <span className="text-3xl font-black text-primary block leading-none">
                    {data.topLocation.count}
                  </span>
                  <span className="text-xs uppercase tracking-widest font-bold text-primary/80 mt-1 block">
                    Vezes
                  </span>
                </div>
              </div>
